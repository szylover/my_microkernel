...
\begin{tikzpicture}[node distance=0cm]
  % g_cmds array
  \foreach \i/\name in {0/cmd\_cls, 1/cmd\_shutdown, 2/cmd\_cmds, 3/cmd\_mmap, 4/...} {
  ...
  \node[draw, minimum width=2.5cm, fill=blue!10, right=2.5cm of g0, font=\tiny\ttfamily] (cls) {name="cls", fn=...};
  \node[draw, minimum width=2.5cm, fill=orange!10, right=2.5cm of g1, font=\tiny\ttfamily] (shut) {name="shutdown", fn=...};
